...
public interface AssignmentRepository extends CrudRepository <Assignment, Integer> {
	...
	@Query("SELECT a FROM Assignment a WHERE a.name=:assignmentName ORDER BY a.id")
	List<Assignment> findByAssignmentName(@Param("assignmentName") String assignmentName);
}
